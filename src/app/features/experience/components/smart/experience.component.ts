...
const EXPERIENCES: Experience[] = [
  {
    ...
    isCurrent: true,
    description:
      'Desenvolvimento full stack em plataformas SaaS de análise de mercado, site institucional e ferramentas de exploração de clientes com IA.',
    achievements: [
      {
        text: 'Redesign completo do site institucional em Next.js com SEO e Google Tags',
        metric: '🚀',
      },
      {
        text: 'SaaS de análise de preços com visualizações interativas em Angular + Django REST',
        metric: '📊',
      },
  ...
  },
  {
    ...
    isCurrent: true,
    description:
      'Desenvolvimento de aplicações web, integração de APIs e automação de processos para clientes diversos.',
    achievements: [
  ...
  },
  {
    ...
    isCurrent: false,
    description:
      'Desenvolvimento de integrações críticas para plataforma fintech de crédito empresarial.',
    achievements: [
      {
        text: 'Integração BNDES / Canal MPME com aumento de 45% na geração de leads',
        metric: '+45% leads',
      },
  ...
  },
  {
    ...
    isCurrent: false,
    description:
      'Integrações, otimizações e reestruturações na plataforma fintech com versionamento autônomo.',
    achievements: [
      {
        text: 'Redução de tempo de relatórios de 40s para 3s (queries otimizadas)',
        metric: '-92% tempo',
      },
